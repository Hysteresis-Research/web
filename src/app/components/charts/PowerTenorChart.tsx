...
const STRINGS: Record<Lang, Strings> = {
  en: {
    title: 'The megawatt, by tenor — what compute-grade power now clears at',
    aria: 'Scatter chart of price per megawatt-hour against contract tenor, both on log axes. Wholesale spot power clears at ten to one hundred fifty dollars at a one-day tenor. TeraWulf–Anthropic, a twenty-year powered-campus lease, implies about two hundred seventy dollars per megawatt-hour; Volta–Bitdeer, a sixteen-year lease, about two hundred seventy-seven. SpaceX–Reflection, a compute rental with GPUs included and a ninety-day exit, is estimated by Neel Somani at roughly five thousand dollars per megawatt-hour. A dashed reference marks the nine-thousand-dollar ERCOT scarcity print.',
    ...
    spx3: '$150M / mo · up to $6.3B thru 2029',
    wulf1: 'TERAWULF–ANTHROPIC · 20 yr',
    wulf2: '≈ $270 · $19B / 401 MW · tenant’s GPUs',
  ...
  zh: {
    title: '兆瓦的期限结构——算力级电力如今成交在哪儿',
    aria: '散点图：横轴为合约期限，纵轴为每兆瓦时价格，双对数坐标。现货日前电价在一天期限上落在 10 到 150 美元。TeraWulf 与 Anthropic 的二十年带电园区租约隐含每兆瓦时约 270 美元；Volta 与 Bitdeer 的十六年租约约 277 美元。SpaceX 与 Reflection 的算力租赁含 GPU、九十天可退出，Neel Somani 估算约每兆瓦时 5,000 美元。虚线为 ERCOT 9,000 美元的稀缺尖峰参照。',
    xTitle: '合约期限（对数）→',
    spot1: '现货 · 日前',
    ...
    spx3: '$150M / 月 · 至 2029 年最多 $6.3B',
    wulf1: 'TERAWULF–ANTHROPIC · 20 年',
    wulf2: '≈ $270 · $19B / 401 MW · 租户自带 GPU',
