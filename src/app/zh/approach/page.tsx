  ...
  return (
    <main lang="zh-Hans">
      <div className="col">
        ...
        <p className="body-paragraph">迟滞 (hysteresis) 描述的不是单纯的延迟，而是路径依赖<span className="em">——</span>系统在经历冲击之后不会回到原点，历史会被吸收进结构本身。在磁学里，磁场保留它被磁化的方式；在经济学里，regime 变化结束很久之后，预期与资本配置仍然带着那次变化的记忆。这个框架是借来的；纪律是经验主义的。我们度量基本面与价格之间的差距，而不是预测它闭合的时刻。我们按持久度配仓，不按信心配仓。Thesis 描述世界；仓位是一笔交易<span className="em">——</span>一个没有写入退出规则的正确判断，是运气，不是技艺。</p>
