    ...
    <main lang="zh-Hans">
      <div className="col">
        ...
        <p className="body-paragraph">
          整整四年，DVOL<span className="em">——</span>Deribit 的 BTC 隐波指数<span className="em">——</span>平均高出 30 日实波 6.6 个 vol-points。机械地卖那道缝隙、每月一次：50 笔交易，66% 胜率，Sharpe 1.34。教科书短波 carry。
        </p>
        ...
        <p className="body-paragraph">
          ...
          <span className="em">——</span>结构性溢价已穿越零线。ETF 上线吸收了散户尾部对冲需求。DVOL 期货给了 street 另一条做空指数的路径。dealer 之间的竞争收掉了剩下的部分。
        </p>
