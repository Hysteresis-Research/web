  ...
  return (
    <main lang="zh-Hans">
      <div className="col">
        ...
        <p className="body-paragraph">这一段已经进入第 145 天，仍在持续。MSTR 历史上只有一段折价拖得更久<span className="em">——</span>180 天，2022 年 1 月到 7 月，上一轮熊市最狠的一段。按持续天数，当前已是<span className="signal">历史第二长</span>。</p>

        <div className="marginalia">§4</div>
        <p className="body-paragraph">历史上 ≥30 天的折价段，已经收口的只有三段。N=3 不是分布，是三个并列的历史样本。在这有限的样本里，从 mNAV 重新站上 1.0 倍那一天起算，MSTR 之后 30/60/90 天的中位数表现是 −2% / −7% / −13%；BTC 对应 −6% / −16% / −12%。到 180 天的所谓&ldquo;反转&rdquo;<span className="em">——</span>MSTR +49%、BTC +26%<span className="em">——</span>其实是其中两段大涨拉出来的，第三段延续了 2022 年熊市的下跌。目前没有 MSTR 多空仓位；mNAV 折价持续天数留作追踪指标。待 mNAV 重新站上 1.0× 之后，按当时 BTC 周期位置与 MSTR 估值结构重新评估。</p>
