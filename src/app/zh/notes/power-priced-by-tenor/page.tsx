...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    '相隔两周的两份算力电力合约：二十年带电园区租约约每兆瓦时 $270，九十天可退的算力租赁估算约 $5,000。产品不同，但决定便宜那一端能否被建出来的，是签约期限。差距为什么大，什么会把它收窄。',
    ...
    <main lang="zh-Hans">
      <section className="article wrap" id="note">
        ...
        <Reveal as="p" className="standfirst">
          <span className="cap">相隔两周的两份合约，给算力级电力标了价。</span>
          两者不是同一种产品，中间的差距大半是硅。它们共有的，是决定便宜那一端能不能被建出来的那个变量：买方愿意签多久。
        </Reveal>
        ...
        <div className="essay">
          ...
          <Reveal as="p" className="lede">
            ...
            IT 兆瓦时约 $270，折合每千瓦·月约 $197。两周之前，6 月 22
            日，彭博、CNBC 与 Axios 报道了 SpaceX 与 Reflection AI
            的协议：2026-07-01 起每月 $150M，付到 2029 年，总额最多
          ...
          <Reveal as="p">
            这两样东西不是同一种产品，差别正是要点。TeraWulf 卖的是带电园区；按
            Somani 的读法，GPU 由租户自带，公告本身对谁出 GPU
            没有说。SpaceX 按报道口径卖的是算力本身，GPU 含在价里。Neel Somani
            曾任对冲基金的电力量化研究员。他免费发布的入门书《Power
            2026》是这篇札记的由头。按他自己的粗算，SpaceX 这笔的价格量级在每兆瓦时
            $5,000
            上下。这个数背后的兆瓦分配没有公开，所以水平只能当估算看，排序却没有疑问，大约十八倍。差价的大头是硅的租金，不是电；分配不公开，两者也拆不干净。所以这两个成交价画不出同一种产品的一条曲线。它们画出的是这个市场的两端，还有另一根轴上把两端分开的那个变量。便宜的那份合约跑二十年，贵的那份九十天就能结束。
          </Reveal>

          <Reveal as="aside" className="marginnote">
            <span className="mn-rule" />
            批发电价成交在每兆瓦时 $10–150；两座长期限带电园区在
            $270–277 上下；九十天的算力租赁连硅一起，再高一个数量级。
          </Reveal>
          ...
          <Reveal as="p">
            ...
            的燃气电厂，造价约
            $10B，靠的就是这一类承购。二十年撑得起这个，九十天什么都撑不起：它只是一份对容量的期权，而稀缺容量上的期权，向来昂贵。「按期限定价」说的就是这层意思：期限不是同一条曲线上的系数，而是一兆瓦能否被融资、被建出来、按成本加成卖而非按稀缺价租的前提条件。签得长，电厂是为你建的；签得短，你付的是别人那座的钱。
          </Reveal>

          <Reveal as="p">
            差距之所以大，是因为供给没法按买方的钟点回应。三家重型燃气轮机厂商，GE
            ...
            的数字，数据中心已占美国用电约
            5%，负荷每两年左右翻一倍。约束咬合一天，短期限的溢价就宽一天，签不了二十年的买家，都在替签得了的买家付钱。
          </Reveal>

          <Reveal as="aside" className="marginnote">
            <span className="mn-rule" />
            什么会把它收窄：涡轮机积压不再拉长；每笔新合约的纯电费率与期限在压缩；一纸费率类别的裁定。政策改价比物理快。
          </Reveal>

          <Reveal as="p">
            什么会把差距收窄，值得提前写下来。第一，涡轮机的积压：看二阶导，别看水平，排队在哪个季度停止拉长。第二，每一笔新算力租约的纯电费率和期限；要是下一笔二十年成交明显低于
            ...
            Park）；一纸费率类别的裁定，让这个板块重估的速度，快过任何一台涡轮机的交付。还有一条我们单独盯着的读法：比特币矿企手里
          ...
          <Reveal as="p">
            ...
            结构里没闭合的那条腿是期限：收入六年，租约十六年。到了这里，期限决定的是买方站在市场的哪一端。
          </Reveal>
          ...
          <Reveal as="p" className="colophon">
            ...
            的公告，公告未说明 GPU 由谁提供；SpaceX–Reflection 条款为彭博、CNBC、Axios
            2026-06-22 的报道口径；Volta–Bitdeer 费率出自 Bitdeer 2026-08-04
